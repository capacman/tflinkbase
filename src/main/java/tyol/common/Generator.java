 ...
 *
 * <p>
 * Results are deterministically determined by the rideId. This guarantees
 * (among other things)
...
public class Generator {
     ...
     *
     * <p>
     * The locations are used in the RideCleansing exercise. We want some rides to
     * be outside of
     * NYC.
     */
     ...
     *
     * <p>
     * The HourlyTips exercise is more interesting if there's some significant
     * variation in
     * tipping.
     */
    public float tip() {
    ...
    /**
     * The LongRides exercise needs to have some rides with a duration > 2 hours,
     * but not too many.
     */
